    ...
    <div className="w-full flex justify-center items-center py-12 px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl shadow-slate-200/60 border border-slate-100 overflow-hidden">
        ...
        <div className="p-6">
          ...
          {result && (
            <div
              className={`mt-6 p-5 rounded-2xl border text-left space-y-3.5 ${
                result.isLate
              ...
              <div>
                <p
                  className={`text-sm font-normal ${
                    result.isLate ? 'text-amber-800/70' : 'text-emerald-600/80'
                  }`}
                >
                  Employee Name
                </p>
                <p
                  className={`font-bold text-base mt-0.5 ${
                    result.isLate ? 'text-[#78350f]' : 'text-[#065f46]'
                  }`}
                >
                  {result.employeeName}
                </p>
              ...
              <div>
                ...
                <p
                  className={`font-bold text-2xl mt-0.5 ${
                    result.isLate ? 'text-[#b45309]' : 'text-[#15803d]'
                  }`}
                >
                  {result.status}
                </p>
