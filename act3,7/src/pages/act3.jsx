        ...
        <div className="w-full flex justify-center items-center py-12 px-4">
            <div className="w-full max-w-md bg-white rounded-2xl shadow-xl shadow-slate-200/60 border border-slate-100 overflow-hidden">
                ...
                <div className="p-6">
                    ...
                    {result && (
                        <div
                            className={`mt-6 p-5 rounded-2xl border text-left space-y-1.5 ${result.theme === 'red'
                        ...
                        >
                            <h3
                                className={`font-bold text-xl ${result.theme === 'red'
                                        ? 'text-[#b91c1c]'
                                        : result.theme === 'amber'
                                            ? 'text-[#b45309]'
                                            : 'text-[#15803d]'
                            ...
                            <p
                                className={`text-sm ${result.theme === 'red'
                                        ? 'text-[#b91c1c]'
                                        : result.theme === 'amber'
                                            ? 'text-[#b45309]'
                                            : 'text-[#15803d]'
