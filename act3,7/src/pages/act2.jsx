        ...
        <div className="w-full flex justify-center items-center py-12 px-4">
            <div className="w-full max-w-md bg-white rounded-2xl shadow-xl shadow-slate-200/60 border border-slate-100 overflow-hidden">
                ...
                <div className="p-6">
                    ...
                    {result && (
                        <div
                            className={`mt-6 p-5 rounded-2xl border text-left space-y-4 ${result.theme === 'green'
                        ...
                        >
                            <div>
                                <p
                                    className={`text-sm font-normal ${result.theme === 'green'
                                            ? 'text-emerald-500'
                                            : result.theme === 'blue'
                                                ? 'text-blue-400'
                                                : result.theme === 'amber'
                                ...
                                <p
                                    className={`font-bold text-base mt-0.5 ${result.theme === 'green'
                                            ? 'text-[#047857]'
                                            : result.theme === 'blue'
                                                ? 'text-[#1d4ed8]'
                                                : result.theme === 'amber'
                            ...
                            <div>
                                ...
                                <p
                                    className={`font-bold text-2xl mt-0.5 ${result.theme === 'green'
                                            ? 'text-[#047857]'
                                            : result.theme === 'blue'
                                                ? 'text-[#1d4ed8]'
                                                : result.theme === 'amber'
